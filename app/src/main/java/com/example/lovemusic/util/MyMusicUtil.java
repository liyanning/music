...
import com.example.lovemusic.activity.ThemeActivity;
import com.example.lovemusic.database.DBManager;
import com.example.lovemusic.entity.AlbumInfo;
import com.example.lovemusic.entity.FolderInfo;
import com.example.lovemusic.entity.MusicInfo;
import com.example.lovemusic.entity.SingerInfo;
import com.example.lovemusic.service.MusicPlayerService;
...
public class MyMusicUtil {
    ...
    public static List<MusicInfo> getCurPlayList(Context context){
        ...
        int playList = MyMusicUtil.getIntShared(com.example.lovemusic.util.Constant.KEY_LIST);
        List<MusicInfo> musicInfoList = new ArrayList<>();
        switch (playList){
            case com.example.lovemusic.util.Constant.LIST_ALLMUSIC:
                musicInfoList = dbManager.getAllMusicFromMusicTable();
                break;
            case com.example.lovemusic.util.Constant.LIST_MYLOVE:
                musicInfoList = dbManager.getAllMusicFromTable(com.example.lovemusic.util.Constant.LIST_MYLOVE);
                break;
            case com.example.lovemusic.util.Constant.LIST_LASTPLAY:
                musicInfoList = dbManager.getAllMusicFromTable(com.example.lovemusic.util.Constant.LIST_LASTPLAY);
                break;
            case com.example.lovemusic.util.Constant.LIST_PLAYLIST:
                int listId = MyMusicUtil.getIntShared(com.example.lovemusic.util.Constant.KEY_LIST_ID);
                musicInfoList = dbManager.getMusicListByPlaylist(listId);
                break;
            case com.example.lovemusic.util.Constant.LIST_SINGER:
                String singerName = MyMusicUtil.getStringShared(com.example.lovemusic.util.Constant.KEY_LIST_ID);
                if (singerName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
                ...
                break;
            case com.example.lovemusic.util.Constant.LIST_ALBUM:
                String albumName = MyMusicUtil.getStringShared(com.example.lovemusic.util.Constant.KEY_LIST_ID);
                if (albumName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
                ...
                break;
            case com.example.lovemusic.util.Constant.LIST_FOLDER:
                String folderName = MyMusicUtil.getStringShared(com.example.lovemusic.util.Constant.KEY_LIST_ID);
                if (folderName == null){
                    musicInfoList = dbManager.getAllMusicFromMusicTable();
                }else {
    ...
    public static void playNextMusic(Context context){
        //获取下一首ID
        DBManager dbManager = DBManager.getInstance(context);
        int playMode = MyMusicUtil.getIntShared(com.example.lovemusic.util.Constant.KEY_MODE);
        Log.d(TAG,"next play mode ="+playMode);
        int musicId = MyMusicUtil.getIntShared(com.example.lovemusic.util.Constant.KEY_ID);
        ...
        MyMusicUtil.setShared(com.example.lovemusic.util.Constant.KEY_ID,musicId);
        if (musicId == -1) {
            Intent intent = new Intent(MusicPlayerService.PLAYER_MANAGER_ACTION);
            intent.putExtra(com.example.lovemusic.util.Constant.COMMAND, com.example.lovemusic.util.Constant.COMMAND_STOP);
        ...
        Intent intent = new Intent(MusicPlayerService.PLAYER_MANAGER_ACTION);
        intent.putExtra(com.example.lovemusic.util.Constant.COMMAND, com.example.lovemusic.util.Constant.COMMAND_PLAY);
        intent.putExtra(com.example.lovemusic.util.Constant.KEY_PATH, path);
        context.sendBroadcast(intent);
    }
    ...
    public static void setShared(String key,int value){
        SharedPreferences pref = com.example.lovemusic.util.MyApplication.getContext().
                getSharedPreferences("music", com.example.lovemusic.util.MyApplication.getContext().MODE_PRIVATE);
    ...
    public static int getIntShared(String key) {
        SharedPreferences pref = com.example.lovemusic.util.MyApplication.getContext().
                getSharedPreferences("music", com.example.lovemusic.util.MyApplication.getContext().MODE_PRIVATE);
        int value;
        if (key.equals(com.example.lovemusic.util.Constant.KEY_CURRENT)){
    ...
    public static void setTheme(Context context, int position) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(com.example.lovemusic.util.Constant.THEME, Context.MODE_PRIVATE);
    ...
    public static void setBingShared(String value){
        SharedPreferences pref = com.example.lovemusic.util.MyApplication.getContext().getSharedPreferences("bing_pic", com.example.lovemusic.util.MyApplication.getContext().MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
