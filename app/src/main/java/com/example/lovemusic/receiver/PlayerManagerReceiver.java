package com.example.lovemusic.receiver;
...
import com.example.lovemusic.util.UpdateUIThread;
...
public class PlayerManagerReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_UPDATE_UI_ADAPTER = "com.example.lovemusic.receiver.PlayerManagerReceiver:action_update_ui_adapter_broad_cast";
