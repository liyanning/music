package com.example.lovemusic.database;
...
import com.example.lovemusic.util.ChineseToEnglish;
...
import static com.example.lovemusic.database.DatabaseHelper.ID_COLUMN;
import static com.example.lovemusic.database.DatabaseHelper.MUSIC_ID_COLUMN;
...
public class DBManager {
    ...
    public void createPlaylist(String name) {   //添加到歌单表
