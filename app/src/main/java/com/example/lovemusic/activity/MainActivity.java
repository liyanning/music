...
import com.example.lovemusic.adapter.HomeListViewAdapter;
import com.example.lovemusic.database.DBManager;
import com.example.lovemusic.entity.PlayListInfo;
import com.example.lovemusic.service.MusicPlayerService;
import com.example.lovemusic.util.Constant;
import com.example.lovemusic.util.HttpUtil;
import com.example.lovemusic.util.MyApplication;
import com.example.lovemusic.util.MyMusicUtil;
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.nav_night_mode:
                        int preTheme = 0;
                        if(MyMusicUtil.getNightMode(MainActivity.this)){
                            //当前为夜间模式，则恢复之前的主题
                            MyMusicUtil.setNightMode(MainActivity.this,false);
                            preTheme = MyMusicUtil.getPreTheme(MainActivity.this);
                            MyMusicUtil.setTheme(MainActivity.this,preTheme);
                        }else {
                            //当前为白天模式，则切换到夜间模式
                            MyMusicUtil.setNightMode(MainActivity.this,true);
                            MyMusicUtil.setTheme(MainActivity.this,ThemeActivity.THEME_SIZE-1);
                        }
//                        Intent intentNight = new Intent(MainActivity.this,MainActivity.class);
...
//                        overridePendingTransition(R.anim.start_anim,R.anim.out_anim);
    ...
    private void init(){
        ...
        lastPlayLl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,LastMyloveActivity.class);
        ...
        myPLAddIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.dialog_create_playlist,null);
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(name)) {
                            Toast.makeText(MainActivity.this,"请输入歌单名",Toast.LENGTH_SHORT).show();
                            return;
                        }
        ...
        myListTitleLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isOpenMyPL){
                    ...
                    playListInfos = dbManager.getMyPlayList();
                    adapter = new HomeListViewAdapter(playListInfos,MainActivity.this,dbManager);
                    listView.setAdapter(adapter);
                }
            }
        });
