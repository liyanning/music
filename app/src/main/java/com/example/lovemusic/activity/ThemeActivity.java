...
import com.example.lovemusic.entity.ThemeInfo;
...
public class ThemeActivity extends BaseActivity {
    ...
    private String[] themeType = {"知乎蓝", "哔哩粉", "酷安绿","网易红","藤萝紫","碧海蓝","樱草绿","咖啡棕","柠檬橙","星空灰","夜间模式"};
    private int[] colors = {R.color.zhihuBlue, R.color.biliPink, R.color.kuanGreen, R.color.cloudRed,
